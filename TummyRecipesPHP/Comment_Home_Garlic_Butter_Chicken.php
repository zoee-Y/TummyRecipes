<?php
    ...
    function setComments()
    {
        ...
        else
        {
            ...
            $stmt = $conn->prepare("INSERT INTO tummy_recipes_comment_garlic_butter_chicken (message) VALUES (?)");
...
<html>
    ...
    <body>
        ...
        <main class="container">
            ...
            <a href="Garlic Butter Chicken.php" class="btn btn-success">Return</a>
        </main>
        <br>
        <?php
