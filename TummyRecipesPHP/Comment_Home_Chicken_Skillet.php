<?php
    ...
    function setComments()
    {
        ...
        else
        {
            ...
            $stmt = $conn->prepare("INSERT INTO tummy_recipes_comment_chicken_skillet (message) VALUES (?)");
...
<html>
    ...
    <body>
        ...
        <main class="container">
            ...
            <a href="Mediterranean Chicken Skillet.php" class="btn btn-success">Return</a>
        </main>
        <br>
        <?php
