            ...
            <section id="Gralic Butter Chicken">
                ...
                <div class="col col-sm-3">
                    <div class="Garlic Butter Chicken">
                        <a class ="">
                            <img src="images/Garlic Butter Chicken.jpg" width="220" class="card-img-top" alt="Garlic Butter Chicken">  
                        </a>
                        ...
                        <h5>3. Season chicken breasts with salt and pepper; arrange chicken in a single layer in prepared baking dish and set aside.</h5>
                        <h5>4. Add butter to a skillet and melt over medium heat.</h5>
                        <h5>5. Stir in garlic and cook over medium heat for 4 to 5 minutes, or until lightly browned, stirring very frequently. DO NOT burn the garlic.</h5>
