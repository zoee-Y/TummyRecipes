...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            <!--4 Images-->
            <section id="Chicken Adobo">
                <h1><b>Chicken Adobo</b></h1>

                <div class="col col-sm-3">
                    <div class="Chicken Adobo">
                        <a class ="">
                            <img src="images/Chicken Adobo.jpg" width="220" class="card-img-top" alt="Chicken Adobo">  
                        </a>
